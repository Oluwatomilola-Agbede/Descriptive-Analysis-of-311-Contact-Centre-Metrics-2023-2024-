...
abandon rates, and service levels. As reflected in the centre's outcomes, it worked efficiently and dealt with 95% of the tasks in 2023. As depicted in the distribution of 
calls, 2% of the total calls are offered. The call handling efficiency for the messages remained high throughout the year, not declining below 98% in any of the months. Moreover, the service level for 2023 was moderate, fluctuating much below the 85% target in many of the months of the year, and abandonment rates were relatively low, with an
average abandonment rate of 4. 8%. These metrics show that this contact centre in 2023 is up and running with little disturbances and strong daily call traffic management. 
